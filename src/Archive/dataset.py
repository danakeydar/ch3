...
#     print(f"sequence size : {data_sequence_full.shape}")
#     data_expression_full = pd.read_csv(directory + filename_expression)
#     print(f"expression size : {data_expression_full.shape}")
#     data_dist_full = pd.read_csv(directory + filename_dist)
#     print(f"dist size : {data_dist_full.shape}")
...
#         data_labels = pd.read_csv(directory + filename_labels)
    ...
    data_sequence_full = pd.read_csv(directory + Conf.filename_sequence)
    ...
    data_expression_full = pd.read_csv(directory + Conf.filename_expression).iloc[:,1:]
    data_dist_full = pd.read_csv(directory + Conf.filename_dist)
    ...
    if is_prediction:
        ...
        data_labels = pd.read_csv(directory + Conf.filename_labels)
